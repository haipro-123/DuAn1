...
import Responsitory.LoaiThitRes;
import Responsitory.InLoaiThitRes;
...
public class LoaiThitSer implements InLoaiThitSer{
    ...
    public ArrayList<LoaiThitViewModel> layDanhSachLoaiThit(){
        ...
        for (LoaiThit lt : list) {
            view.add(new LoaiThitViewModel(stt, lt.getId(), lt.getIDThit(), lt.getTen(), lt.getDonGia(), lt.getHSD()));
            stt++;
        }
        return view;
    }
